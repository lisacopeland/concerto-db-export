...
async function main(): Promise<void> {
  const conn = await mysql.createConnection({
    ...
    port: Number(process.env.DEST_DB_PORT || 3303),
    user: process.env.DEST_DB_USER || 'root',
    password: process.env.DEST_DB_PASSWORD || 'Testing123!',
    database: process.env.DEST_DB_NAME || 'concerto_lcl',
  ...
  try {
    ...
    `,
        [country.code, country.code3, country.name, country.number],
      );
    }
